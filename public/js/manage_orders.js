...
const t = {
    ar: {
        pageTitle: systemMode === 'restaurant' ? 'فواتير المطعم' : 'إدارة الطلبات',
        refresh: 'تحديث',
        all: 'الكل',
        paid: 'أونلاين',
        pending: 'نقدي',
        cancelled: 'ملغي',
        searchPlaceholder: systemMode === 'restaurant' ? 'ابحث برقم البون أو الطاولة...' : 'ابحث برقم الطلب أو اسم العميل...',
        tableOrder: systemMode === 'restaurant' ? 'البون' : 'الطلب',
        tableDate: 'التاريخ',
        tableCustomer: systemMode === 'restaurant' ? 'الطاولة' : 'العميل',
        tableTotal: 'الإجمالي',
        tablePayment: 'حالة الدفع',
        tableDelivery: 'التوصيل',
        tableStatus: 'الحالة',
        sidebarTitle: systemMode === 'restaurant' ? 'تفاصيل البون' : 'تفاصيل الطلب',
        sidebarItems: systemMode === 'restaurant' ? 'الوجبات' : 'الأصناف',
        sidebarCustomer: systemMode === 'restaurant' ? 'بيانات الطاولة' : 'بيانات العميل',
        ...
        cashCustomer: systemMode === 'restaurant' ? 'طاولة نقدية' : 'عميل نقدي',
        noPhone: 'بدون هاتف',
        ...
        todayTotal: systemMode === 'restaurant' ? 'إجمالي فواتير اليوم:' : 'إجمالي الطلبات اليوم:',
        sidebarPrice: 'السعر:',
        ...
        card: 'فيزا / محفظة',
        cash: 'نقدي',
        shiftTotal: 'إجمالي وردية العمل:',
        onlineTotal: 'إجمالي الأونلاين:',
        cashTotal: 'إجمالي النقدي:',
        cancelledTotal: 'إجمالي الملغاة:'
    },
    en: {
        pageTitle: systemMode === 'restaurant' ? 'Restaurant Bills' : 'Manage Orders',
        refresh: 'Refresh',
        all: 'All',
        paid: 'Online',
        pending: 'Cash',
        cancelled: 'Cancelled',
        searchPlaceholder: systemMode === 'restaurant' ? 'Search by bill or table...' : 'Search by order ID or customer...',
        tableOrder: systemMode === 'restaurant' ? 'Bill #' : 'Order',
        tableDate: 'Date',
        tableCustomer: systemMode === 'restaurant' ? 'Table' : 'Customer',
        tableTotal: 'Total',
        tablePayment: 'Payment Status',
        tableDelivery: 'Delivery',
        tableStatus: 'Status',
        sidebarTitle: systemMode === 'restaurant' ? 'Bill Details' : 'Order Details',
        sidebarItems: systemMode === 'restaurant' ? 'Meals' : 'Items',
        sidebarCustomer: systemMode === 'restaurant' ? 'Table Info' : 'Customer Info',
        ...
        cashCustomer: systemMode === 'restaurant' ? 'Cash Table' : 'Cash Customer',
        noPhone: 'No Phone',
        ...
        todayTotal: systemMode === 'restaurant' ? "Today's Bills Total:" : "Today's Total Orders:",
        sidebarPrice: 'Price:',
        sidebarVat: 'VAT:',
